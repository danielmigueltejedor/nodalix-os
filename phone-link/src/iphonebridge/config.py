...
BLE_ADVERT_LOCAL_NAME: str = os.environ.get(
    "IPHONEBRIDGE_BLE_NAME", "nodalix"
)

COPY_VERIFICATION_CODES: bool = os.environ.get(
    "IPHONEBRIDGE_COPY_VERIFICATION_CODES", "0"
...
def ensure_dirs() -> None:
    ...
    os.chmod(STATE_DIR, stat.S_IRWXU)  # 0700: messages and contacts are private
