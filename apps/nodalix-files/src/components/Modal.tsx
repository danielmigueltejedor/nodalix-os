...
export default function Modal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      />
      <div
        className={`nodalix-modal nodalix-animate-in relative w-full ${w} rounded-2xl border border-nodalix-border bg-[rgba(24,24,37,0.96)] shadow-2xl shadow-black/60`}
