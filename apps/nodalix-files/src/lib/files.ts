...
export const getPdfThumbnail = (path: string) =>
  invoke<string | null>("get_pdf_thumbnail", { path });
export const getThumbnailDataUrl = (path: string) =>
  invoke<string | null>("get_thumbnail_data_url", { path });
