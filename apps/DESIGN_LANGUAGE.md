...
- Inter for general UI with the shared fallback stack in `assets/styles/nodalix-fonts.css` (recommended package: `inter-font`).
- JetBrainsMono Nerd Font / JetBrains Mono for monospace and technical surfaces only.
