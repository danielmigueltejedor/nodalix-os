...
o.bind("CTRL + ALT + DELETE", "Close all windows", "hyprctl clients -j | jq -r '.[].address' | xargs -r -I{} hyprctl dispatch closewindow address:{}")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "hyprctl dispatch togglefloating active; hyprctl dispatch pin active")
o.bind("SUPER + L", "Toggle workspace layout", "hyprctl dispatch togglesplit")
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "notify-send 'Nodalix' 'Monitor scaling pendiente de migrar'")
o.bind("SUPER + ALT + code:61", "Cycle monitor scaling backwards", "notify-send 'Nodalix' 'Monitor scaling pendiente de migrar' --reverse")
