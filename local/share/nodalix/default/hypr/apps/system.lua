...
o.window("(org.nodalix.bluetui|org.nodalix.impala|org.nodalix.wiremix|org.nodalix.btop|org.nodalix.terminal|org.nodalix.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|com.gabm.satty|Nodalix|About|TUI.float|imv|mpv)", { tag = "+floating-window" })
...
o.window("org.nodalix.screensaver", { fullscreen = true, float = true, animation = "slide" })
...
hl.layer_rule({ match = { namespace = "nodalix-image-selector" }, no_anim = true })
