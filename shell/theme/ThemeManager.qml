...
QtObject {
    ...
    readonly property var availableThemes: [
        { id: "nodalix",                name: I18n.tr("Nodalix"),                dark: true  },
        { id: "wallpaper",              name: I18n.tr("Wallpaper"),              dark: true  },
        { id: "catppuccin-mocha",       name: I18n.tr("Catppuccin Mocha"),       dark: true  },
        { id: "catppuccin-macchiato",   name: I18n.tr("Catppuccin Macchiato"),   dark: true  },
        { id: "catppuccin-frappe",      name: I18n.tr("Catppuccin Frappé"),      dark: true  },
        { id: "catppuccin-latte",       name: I18n.tr("Catppuccin Latte"),       dark: false },
        { id: "nord",                   name: I18n.tr("Nord"),                   dark: true  },
        { id: "tokyo-night",            name: I18n.tr("Tokyo Night"),            dark: true  },
        { id: "tokyo-night-storm",      name: I18n.tr("Tokyo Night Storm"),      dark: true  },
        { id: "tokyo-night-light",      name: I18n.tr("Tokyo Night Light"),      dark: false },
    ]
    ...
    // ── Active theme state ───────────────────────────────────────────────────
    property string activeId: "nodalix"
    property var    _data:    ({})
