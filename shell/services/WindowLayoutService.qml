...
QtObject {
    ...
    readonly property string mode: SettingsService.get("windows.layoutMode", "tiling")
    property bool busy: false
    property string statusText: ""

    readonly property var modes: [
        { id: "tiling", icon: "󰕰", name: I18n.tr("Mosaic"), description: I18n.tr("Automatic Hyprland tiling") },
        { id: "scrolling", icon: "󰁔", name: I18n.tr("Flow"), description: I18n.tr("Horizontal scrolling and vertical workspace wheel") },
        { id: "tabs", icon: "󰓩", name: I18n.tr("Tabs"), description: I18n.tr("One visible window per native tab group") }
    ]

    function setMode(next) {
        if (busy || ["tiling", "scrolling", "tabs"].indexOf(next) < 0) return
        SettingsService.set("windows.layoutMode", next)
    ...
    function cycle() {
        const order = ["tiling", "scrolling", "tabs"]
