...
QtObject {
    ...
    readonly property var deps: ({
        "skwd-helm": { bin: "skwd-helm", pkg: "nodalix-wallpaper-engine", desc: "Unified wallpapers" },
        ...
        "tailscale":          { bin: "tailscale",           pkg: "tailscale",            desc: "Tailscale VPN integration" },
        ...
        "fwupdmgr":           { bin: "fwupdmgr",            pkg: "fwupd",                desc: "Firmware updates" }
    })
