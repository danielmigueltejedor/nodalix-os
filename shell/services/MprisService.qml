...
QtObject {
    ...
    property Timer _poll: Timer {
        // MPRIS properties themselves are reactive. A slow tick is enough to
        // reconsider the preferred player while one exists; playback position
        // is handled by the dedicated smooth timer above.
        interval: 5000; repeat: true; running: root.active !== null
